...
export const projects: Project[] = [
  {
    id: 'yachtpricer',
    title: 'YachtPricer',
    label: 'Сервис анализа цен для чартерных компаний',
    tagline: 'Динамическое ценообразование для чартерных яхт',
    description:
  ...
  {
    id: 'frozenocean',
    title: 'FrozenOcean.travel',
    label: 'Сайт полярных яхтенных экспедиций (EN/DE/RU)',
    tagline: 'Каталог экспедиций и флота: Антарктида, Гренландия, Лофотены',
    description:
      'Маркетинговый сайт и каталог экспедиций: мультиязычность (i18n), страницы экспедиций и флота, карточки с ценами и доступностью, единый стиль UI и аккуратная типографика.',
    image: '/images/projects/frozenocean-01.png',
    screenshots: [
      '/images/projects/frozenocean-01.png',
      '/images/projects/frozenocean-02.png',
      '/images/projects/frozenocean-03.png',
    ],
    href: '/projects/frozenocean',
    tags: ['React', 'TypeScript', 'Tailwind', 'i18next', 'Vite', 'UI Polish'],

    businessGoal:
      'Сделать понятный и визуально “дорогой” сайт для продажи полярных экспедиций: быстро донести ценность маршрутов, показать флот и упростить контакт/заявку для бронирования.',

    challenge:
      'Многостраничный контент (экспедиции, флот, условия), необходимость мультиязычности и консистентного UI. Плюс — полировка карточек и микровзаимодействий, чтобы дизайн выглядел премиально и не “сыпался” на разной длине текста.',

    solution: [
      'Внедрена i18n-структура (EN/DE/RU) и выровнены ключи переводов.',
      'Собран каталог экспедиций на данных из переводов: цена, дата следующего выхода, яхта, доступность.',
      'Улучшены карточки: бейджи доступности/цены, единый визуальный язык, выравнивание CTA по низу карточек.',
      'Страницы флота и экспедиций структурированы под “продажу приключения”: блоки, типографика, акценты.',
      'Проработан и отредактирован копирайтинг: тексты описания экспедиций, миссия проекта, описания флота и смысловые акценты для разных аудиторий.'    ],

    results: [
      'Сформулирована понятная миссия проекта и ценностное предложение для аудитории экспедиций.',
      'Сайт выглядит консистентно на разных языках и длинах текста.',
      'Карточки экспедиций стали визуально ровными и “премиальными”, CTA всегда на одном уровне.',
      'Контент, тексты и навигация работают как единый рассказ — пользователю проще понять формат экспедиций, выбрать маршрут и оставить заявку.',
      'Проект воспринимается как цельный бренд, а не просто каталог туров.'
    ]
  },

  {
    ...
    tagline: 'Интерактивная карта мест салона самолета внутри Sabre Red 360',
    description:
...

  {
    ...
    label: 'Цифровая экосистема для развития персонального бренда',
    tagline: 'Решение для тех, кто строит свой личный бренд и цифровой бизнес вокруг него',
    description:
      'Open Digital Hub — это современные лендинги, блог, CMS, видеоконференцсвязь, структурированный коммюнити-чат, дистанционное обучение, платежи и n8n-автоматизации. Интегрированная платформа для консалтинга, EdTech и AI-сервисов, на базе которой выстраиваются продвижение продукта и продажи.',
