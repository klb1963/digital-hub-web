...
export const projects: Project[] = [
...

  {
    ...
    description:
      'Open Digital Hub — это современные лендинги, блог, CMS, видеокнференцсвязь, структурированный коммюнити-чат, дистанционное обучение, платежи и n8n-автоматизации. Интегрированная платформа для консалтинга, EdTech и AI-сервисов, на базе которой выстраиваются продвижение продукта и продажи.',
