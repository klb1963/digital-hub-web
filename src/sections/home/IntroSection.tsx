            ...
            <div className="relative space-y-6 text-base leading-relaxed text-slate-200 md:text-lg">
              ...
              <div className="space-y-4">
                ...
                <p>
                  ...
                  Проектирую и собираю под ключ цифровую экосистему под вашим брендом: сайт, блог, CRM, LMS, видеосвязь, комьюнити, личные кабинеты, оплату и интеграции — всё на единой платформе.
                </p>
