            ...
            >
              <div className="space-y-4 text-base leading-relaxed md:text-lg text-slate-700">
                ...
                <p>
                  ...
                  <br />
                  «Я хочу развивать личный бренд, но не понимаю, с чего начать, чтобы потом не переделывать заново,
                  какую техническую инфраструктуру выбрать и как всё связать между собой.»
                </p>
